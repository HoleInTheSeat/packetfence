...
sub locationlog_insert_start {
    my ( $switch, $switch_ip, $switch_mac, $ifIndex, $vlan, $mac, $connection_type, $connection_sub_type, $user_name, $ssid, $stripped_user_name, $realm, $role, $locationlog_mac, $ifDesc, $voip, $teap_username, $teap_machinename) = @_;
...
sub locationlog_synchronize {
    ...
    my ( $switch, $switch_ip, $switch_mac, $ifIndex, $vlan, $mac, $voip_status, $connection_type, $connection_sub_type, $user_name, $ssid, $stripped_user_name, $realm, $role, $ifDesc, $teap_username, $teap_machinename) = @_;
    ...
    if ( defined($mac) ) {
        ...
        if (defined($locationlog_mac) && ref($locationlog_mac) eq 'HASH') {
            ...
            if (!_is_locationlog_accurate($locationlog_mac, $switch, $ifIndex, $vlan,
                ...
                locationlog_insert_start($switch, $switch_ip, $switch_mac, $ifIndex, $vlan, $mac, $connection_type, $connection_sub_type, $user_name, $ssid, $stripped_user_name, $realm, $role, $locationlog_mac, $ifDesc, $voip_status, $teap_username, $teap_machinename);
    ...
    if ($mustInsert && !$inserted) {
        locationlog_insert_start($switch, $switch_ip, $switch_mac, $ifIndex, $vlan, $mac, $connection_type, $connection_sub_type, $user_name, $ssid, $stripped_user_name, $realm, $role, undef, $ifDesc, $voip_status, $teap_username, $teap_machinename)
